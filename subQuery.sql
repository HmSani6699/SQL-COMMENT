...
-- Sub query amra 3 ta way te korte pari
-- SELECT   // aloyes amader single value r jonno bebohar korte hobe
-- From     // multy value r jonno bebohar korte pari
-- WHERE    // single value r jonno
